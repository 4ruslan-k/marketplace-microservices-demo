...
const (
	...
	productCreatedDurableConsumerName = "cart-product-created"
	productDeletedDurableConsumerName = "cart-product-deleted"
	productUpdatedDurableConsumerName = "cart-product-updated"
