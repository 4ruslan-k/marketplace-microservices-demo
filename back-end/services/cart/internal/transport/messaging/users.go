...
const (
	...
	userCreateDurableConsumerName = "cart-user-create"
	userDeleteDurableConsumerName = "cart-user-delete"
	userUpdateDurableConsumerName = "cart-user-update"
)
