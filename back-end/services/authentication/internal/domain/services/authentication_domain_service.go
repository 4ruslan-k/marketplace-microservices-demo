...
import (
	passwordVerificationEntity "authentication/internal/domain/entities/password_verification_token"
	repositories "authentication/internal/repositories/authentication"
	"bytes"
	"context"
	"fmt"
	"image/png"
